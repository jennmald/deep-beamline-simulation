...
def preprocess():
    ...
    """
    # 500 simulations
    train_file = dbs_repository_path / "NSLS-II-TES-beamline-rsOptExport-2/rsopt-srw-20220311163123/datasets/results.h5"
...
training_dataloader, testing_dataloader = build_beam_intensity_dataloaders("preprocessed_results.h5", batch_size=5)
...
beamline = "TES"
train_dataloader, test_dataloader = build_beam_intensity_dataloaders("preprocessed_results.h5", batch_size=5)
epoch_count = 1000  # 1000 is good if you have the time
